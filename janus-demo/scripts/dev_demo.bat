...
echo Starting frontend on 5173 (Demo Mode)...
start "janus-frontend-demo" cmd /c "cd /d frontend && set VITE_DEMO_MODE=1 && npm install && npm run dev -- --port 5173 --strictPort --host"
