# Create advanced Analytics.jsx
analytics_jsx = """import { useState, useEffect } from 'react';
import {
...
with open('frontend/src/pages/Analytics.jsx', 'w', encoding='utf-8') as f:
    f.write(analytics_jsx)

print("✓ Analytics.jsx created successfully with 26+ KPIs and advanced visualizations!")
